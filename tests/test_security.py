...
class TestInputValidation:
    ...
    def test_validate_text_input_max_length(self):
...
class TestBarcodeDataValidation:
    ...
    def test_validate_barcode_data_valid(self):
...
class TestLocalImagePathValidation:
    ...
    def test_validate_local_image_path_valid(self):
    ...
    def test_validate_local_image_path_traversal(self):
        """Test path traversal protection."""
        with pytest.raises(HomeAssistantError, match="forbidden characters"):
            validate_local_image_path("../../../etc/passwd")

    def test_validate_local_image_path_invalid_extension(self):
...
class TestLogSanitization:
    ...
    def test_sanitize_log_message_with_sensitive(self):
...
class TestIntegrationSecurity:
    ...
    def test_qr_validation_edge_cases(self, invalid_input, expected_error):
